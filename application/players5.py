...
class players5(Screen):
    def __init__(self, **kwargs):
        ...
        gl2 = GridLayout(cols=6, rows=29, spacing=(15 , 5), padding= 1, size_hint_y=None, height= 950)
        ...
        self.name_5 = TextInput(hint_text= "Имя и Фамилия", size_hint_y=None, height= 32)
